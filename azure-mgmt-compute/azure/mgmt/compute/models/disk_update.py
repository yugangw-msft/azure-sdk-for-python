...
class DiskUpdate(ResourceUpdate):
    ...
    :param os_state: the Operating System state. Possible values include:
     'Generalized', 'Specialized'
    :type os_state: str or :class:`OperatingSystemStateTypes
     <azure.mgmt.compute.models.OperatingSystemStateTypes>`
    ...
    def __init__(self, tags=None, account_type=None, os_type=None, os_state=None, creation_data=None, disk_size_gb=None, encryption_settings=None):
        super(DiskUpdate, self).__init__(tags=tags)
